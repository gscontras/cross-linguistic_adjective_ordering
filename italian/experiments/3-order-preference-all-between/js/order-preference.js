...
function make_slides(f) {
  ...
  slides.multi_slider = slide({
    ...
    present_handle : function(stim) {
      ...
      // this.condition = _.sample(["NAA","AAN","ANA"])


      if (exp.condition == "NAA") {
          if (gender == "masculine") {
      ...
      if (exp.condition == "AAN") {
          if (gender == "masculine") {
          $(".low").html("\"il "+ stim.Predicate2.Predicate + " " + stim.Predicate1.Predicate + " " + stim.Noun  + "\"");

          $(".high").html("\"il "+  stim.Predicate1.Predicate + " " + stim.Predicate2.Predicate + " " + stim.Noun + "\"");

          } else {
          $(".low").html("\"la "+ stim.Predicate2.FemPredicate + " " + stim.Predicate1.FemPredicate + " " + stim.Noun  + "\"");

          $(".high").html("\"la "+ stim.Predicate1.FemPredicate + " " + stim.Predicate2.FemPredicate + " " + stim.Noun  + "\"");

          } 
      } 

      if (exp.condition == "ANA") {
          if (gender == "masculine") {
          $(".low").html("\"il "+ stim.Predicate2.Predicate + " " + stim.Noun + " " + stim.Predicate1.Predicate + "\"");

          $(".high").html("\"il "+  stim.Predicate1.Predicate + " " + stim.Noun + " " + stim.Predicate2.Predicate + "\"");

          } else {
          $(".low").html("\"la "+ stim.Predicate2.FemPredicate + " " + stim.Noun + " " + stim.Predicate1.FemPredicate + "\"");

          $(".high").html("\"la "+ stim.Predicate1.FemPredicate + " " + stim.Noun + " " + stim.Predicate2.FemPredicate + "\"");
...
function init() {
  ...
  exp.condition = _.sample(["NAA","AAN","ANA"]);
  exp.system = {
